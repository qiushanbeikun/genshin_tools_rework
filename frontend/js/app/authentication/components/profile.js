        ...
        <Grid item xs={3}>
          ...
          <FormikProvider value={formik}>
            <form onSubmit={formik.handleSubmit}>
              ...
              <TextField name="email" type="email" variant="outlined" margin="normal" label="Email" fullWidth disabled
                         value={formik.values.email}/>
              <TextField name="genshin_server" variant="outlined" margin="normal" label="Genshin Server" fullWidth
                         value={formik.values.genshin_server} onBlur={formik.handleBlur}
                         onChange={formik.handleChange}/>

              <TextField name="genshin_uid" variant="outlined" margin="normal" label="Genshin UID" fullWidth
